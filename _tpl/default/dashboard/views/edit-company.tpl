...
<div class="dash-form mlm20">
	<form id="register-form" name="register-form" method="post" action="/dashboard-company" role="form" enctype="multipart/form-data">
		...
		<div class="col-md-6 col-xs-12 mlReset">
			...
			<textarea required class="form-control noTinymceTA" maxlength="1000" name="company_desc" id="company_desc" rows="10">{$company.description}</textarea>
			<div class="textarea-feedback mb40" id="textarea_feedback"></div>
		...
		<div class="col-md-6 col-xs-12 pl5p mb50">
			...
			<button type="submit" class="btn mbtn fl" name="submit" id="submit" onclick="return SimpleJobScript.registerFormValidationSecondStep();" ><i class="fa fa-check fa-lg" aria-hidden="true"></i></button>
