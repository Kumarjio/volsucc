					...
					<div class="row " id="step-1">
					 <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 mlpl0">
						...
						<div class="row checkboxes">
							...
							<div id="apply-desc-block" class="row checkboxes displayNone">
								<div class="col-md-12 col-xs-12 mtm20" >
									<h3 class="process-heading">{$translations.dashboard_recruiter.howto_apply_label}</h3>
						
									<textarea id="howtoTA" class="noTinymceTA process-textarea" rows="5" cols="5" id="howtoapply" name="howtoapply"></textarea>
								</div>
							</div>
