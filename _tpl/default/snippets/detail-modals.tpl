  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer preview-footer">
        ...
        <button type="button" class="btn btn-green" onclick="SimpleJobScript.ReportSpam();" data-dismiss="modal">{$translations.detail_sidebar.modal_submit}</button>

        <button type="button" class="btn btn-gray" data-dismiss="modal">{$translations.job_detail_section.close}</button>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer preview-footer">
        ...
        <button type="button" class="btn btn-green" onclick="SimpleJobScript.TellAFriend();" data-dismiss="modal">{$translations.detail_sidebar.modal_submit}</button>
