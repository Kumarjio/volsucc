<?php
	...
	*
	*  Product core extends basic architecture based on open source solution http://www.jobberbase.com. Credit is hereby given.
	...
	*/
	...
	// get custom styles
	$miniSql = 'SELECT * FROM css';
	$r = $db->query($miniSql);
	$css_data = $r->fetch_assoc();
	$smarty->assign('custom_css', $css_data['cssarea']);
