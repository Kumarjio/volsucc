(function() 
{
	Jobber = {
		...
		removeSMentry: function(entry_id) {
			...
			if (links_count < 4) {
				$('#addLink').html('').html('Добавить соц. сети [ + ]');
			}
			   	...
			   	if (msg != "0")
					{
						...
						else
						{
							...
							linkElement.setAttribute('title', 'Деактивировать вакансию');
							...
							jobberBase.messages.add('Вакансия деактивирована!');
						}	
					}
			  }
			});
			   	...
			   	if (msg != "0")
					{
						...
						var linkElement = document.getElementById(currentLinkId);
						linkElement.setAttribute('title', 'Доступ');
						...
						jobberBase.messages.add('Доступ запрещен!');
					}
			  }
			});
		},
			   	...
			   	if (msg != "0")
					{
						...
						jobberBase.messages.add('Доступ разрешен!');
					}
			  }
			});
		},
			   	...
			   	if (msg != "0")
					{
						...
						var linkElement = document.getElementById(currentLinkId);
						linkElement.setAttribute('title', 'Включить выделение');
						linkElement.setAttribute('onclick', activateJobFunction);
						linkElement.onclick = activateJobFunction;
						linkElement.innerHTML = '<i class="fa fa-circle-o fa-lg green-fa" aria-hidden="true"></i>';
						linkElement.id = 'activateLink'+job_id;
						jobberBase.messages.add('Выделение активировано!');
					}
			  }
			});
		},
                   ...
                   if (msg != "0")
                    {
						...
						var linkElement = document.getElementById(currentLinkId);
						linkElement.setAttribute('title', 'Выключить выделение');
                        ...
                        jobberBase.messages.add('Выделение деактивировано!');
                    }
              }
            });
        },
		...
		Delete: function(url, job_id)
		{
            ...
            if (Jobber.I18n.js.delete_job_confirmation_question === undefined) {
            	Jobber.I18n.js.delete_job_confirmation_question = "Вы действительно хотите удалить эту вакансию??";
            }
				   	...
				   	if (msg != "0")
						{
							...
							jobberBase.messages.add('Вакансия удалена');
						}
				  }
				});
			}
