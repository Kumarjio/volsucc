(function() 
{
	SimpleJobScript = {
		...
		GetAjaxApplicationsUnderReview: function(theme) {
				...
				$.ajax({ url: '/get_job_applications_under_review_ajax.php',
					...
					for(var obj in json.result) {
						...
						html += '<td>' + data[obj].skills_formated + '</td>';
						html += '<td>' + loc + '</td>';
						if (NOCV)
							html += '<td>-</td>';
						else
		...
		CreateModals: function(app) {
			...
			content += '</div>';
			content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.applied_label + '</div>' + app.date_formated + '</div>';
			content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.email_label + '</div>' + app.email + '</div>';
			if (app.phone != '')
				content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.phone_label + '</div><a href=\"tel:' + app.phone + '\">' + app.phone + '</a></div>';
			if (app.website != '')
				content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.website_label + '</div><a href=\"http://' + app.website + '\" target=\"_blank\">' + linkToShow + '</a></div>';

			if (sm_content != '') {
				content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.social_media_label + '</div>' + sm_content + '</div>';
			}
			content += '<div class=\"modal-body\"><div class=\"modal-label mb5\">' + SimpleJobScript.I18n.js.application_message + '</div><br /> ' + app.message + '</div>';
