<?php 
    ...
    $sql = 'SELECT c.id as "candidate_id", c.fullname as "candidate_name", c.email as"candidate_email", c.public_profile as "public_profile", c.confirmed as "candidate_confirmed" FROM applicant c ORDER BY id DESC limit ' .$offset . ', ' . SUBSCRIBERS_PER_PAGE;
    $data = $db->query($sql);
